...
class AccountController extends Controller
{
    ...
    */
    public function dashboard() {
        ...
        try {
            // $data['totalActiveService']     = Service::where(['status' => '1'])->whereNull(['deleted_at'])->count();
            $data['totalService']           = Service::whereNull(['deleted_at'])->count();
            // $data['totalActivePortfolio']   = Portfolio::where(['status' => '1'])->whereNull(['deleted_at'])->count();
            $data['totalPortfolio']         = Portfolio::whereNull(['deleted_at'])->count();
            $data['totalEnquiry']           = Enquiry::count();
