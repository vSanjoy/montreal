...
# Author            :
# Created Date      :
# Page/Class name   : ContactsController
...
class ContactsController extends Controller
{
    ...
    public $pageRoute       = 'contact';
    public $listUrl         = 'contact.list';
    public $listRequestUrl  = 'contact.ajax-list-request';
    public $viewUrl         = 'contact.view';
    public $deleteUrl       = 'contact.delete';
    public $viewFolderPath  = 'admin.contact';
    ...
    */
    public function __construct($data = null) {
        ...
        $this->management   = trans('custom_admin.label_menu_contact');
    ...
    */
    public function list(Request $request) {
        $data = [
            'pageTitle'     => trans('custom_admin.label_contact_list'),
            'panelTitle'    => trans('custom_admin.label_contact_list'),
            'pageType'      => 'LISTPAGE'
        ];
    ...
    /*
        ...
        * Modified Date : 
        * Input Params  : Request $request
        * Return Value  : Returns contact data
    */
            ...
            if ($request->ajax()) {
                ...
                if ($id != null) {
                    ...
                    if ($details != null) {
                        ...
                        $message    .= '<tr><td>'.trans('custom_admin.label_phone_number').'</td><td>'.$details->phone.'</td></tr>';
                        $message    .= '<tr><td>'.trans('custom_admin.label_subject').'</td><td>'.$details->subject.'</td></tr>';
                        $message    .= '<tr><td>'.trans('custom_admin.label_message').'</td><td>'.$details->message.'</td></tr>';
                    }
                }
            }
        } catch (Exception $e) {
    ...
    */
    public function export(Request $request) {
        ...
        try {
            return Excel::download(new ContactsExport, 'contact_'.time().'.xlsx');
        } catch (Exception $e) { 
            $message = $e->getMessage();
        } catch (\Throwable $e) {
            $message = $e->getMessage();
