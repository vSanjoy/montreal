...
$(document).ready(function() {
    ...
    // Start :: Portfolio Category Form //
    $("#createPortfolioCategoryForm").validate({
        ignore: [],
        debug: false,
        rules: {
            title: {
    ...
    $("#updatePortfolioCategoryForm").validate({
        ignore: [],
        debug: false,
        rules: {
            title: {
        ...
        errorPlacement: function(error, element) {
            if ($(element).attr('id') == 'description') {
                error.insertAfter($(element).parents('div.form-group'));
            } else if ($(element).attr('id') == 'service_ids') {
                error.insertAfter($(element).parents('div.form-group'));
            } else {
                error.insertAfter(element);
            }
...
// Start :: Delete upladed cropped image //
